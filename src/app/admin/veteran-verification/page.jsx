...
// file: src/app/admin/veteran-verification/page.jsx v2 - Admin verification review matching existing admin structure
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                            ...
                            <div className="bg-green-50 border border-green-200 rounded-lg shadow-md p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-sm font-medium text-green-800">Verified This Month</p>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg shadow-md p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                        <p className="text-sm font-medium text-red-800">Denied This Month</p>
